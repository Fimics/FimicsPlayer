...
@Router(path = "/demo/HookButtonActivity")
public class HookButtonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(HookButtonActivity.this, "" + ((Button) v).getText(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void hook(View view) throws Exception {
        ...
        Object mOnClickListenerProxy = Proxy.newProxyInstance(HookButtonActivity.class.getClassLoader(), // 1加载器
                ...
                new InvocationHandler() { // 3监听接口方法里面的回调
                    ...
                    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                        ...
                        Button button = new Button(HookButtonActivity.this);
