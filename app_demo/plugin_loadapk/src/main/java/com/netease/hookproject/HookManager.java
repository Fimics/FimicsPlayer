...
public class HookManager {
    ...
    public HookManager(Activity activity) {
...
//        }
    ...
    private void hookAmsAction() throws Exception {
        ...
        Object mIActivityManagerProxy = Proxy.newProxyInstance(
                ...
                HookManager.class.getClassLoader(),
    ...
    private void pluginToAppAction() throws Exception {
        ...
        PathClassLoader pathClassLoader = (PathClassLoader) activity.getClassLoader(); // 本质就是PathClassLoader
        ...
        File fileDir = activity.getDir("pluginDir", Context.MODE_PRIVATE); // data/data/包名/pluginDir/
        DexClassLoader dexClassLoader = new
                DexClassLoader(pluginPath, fileDir.getAbsolutePath(), null, activity.getClassLoader());
    ...
    public Resources getResources() {
        return resources == null ? activity.getResources() : resources;
    }

    public AssetManager getAssets() {
        return assetManager == null ? activity.getAssets() : assetManager;
    }
    ...
    private void customLoadedApkAction() throws Exception {
        ...
        File fileDir = activity.getDir("pulginPathDir", Context.MODE_PRIVATE);

        // 自定义 加载插件的 ClassLoader
        ClassLoader classLoader = new PluginClassLoader(pulginPath,fileDir.getAbsolutePath(), null, activity.getClassLoader());
    ...
    private void hookGetPackageInfo() {
        try {
            ...
            Object mIPackageManagerProxy = Proxy.newProxyInstance(activity.getClassLoader(),
