...
@Router(path ="/match_demo/MatchDisplayCutoutActivity")
public class MatchDisplayCutoutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_screen_match_cutout);
