package com.mic.router.compiler.utils;
...
public class Constants {
    ...
    // 注解处理器中支持的注解类型
    public static final String AROUTER_ANNOTATION_TYPES = "com.mic.router.annotation.Router";
    public static final String PARAMETER_ANNOTATION_TYPES = "com.mic.router.annotation.Parameter";
    ...
    // 包名前缀封装
    public static final String BASE_PACKAGE = "com.mic.router.api";
    // 路由组Group加载接口
    public static final String AROUTE_GROUP = BASE_PACKAGE + ".core.RouterLoadGroup";
    // 路由组Group对应的详细Path加载接口
    public static final String AROUTE_PATH = BASE_PACKAGE + ".core.RouterLoadPath";
    // 获取参数，加载接口
