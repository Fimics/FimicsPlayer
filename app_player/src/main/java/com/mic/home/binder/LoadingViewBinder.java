...
public class LoadingViewBinder extends ItemViewBinder<AndroidUI, LoadingViewBinder.ViewHolder> {

    @NonNull
    @Override
    protected ViewHolder onCreateViewHolder(@NonNull LayoutInflater inflater, @NonNull ViewGroup parent) {
        return new ViewHolder(inflater.inflate(R.layout.binder_loading_view,parent,false));
    }
